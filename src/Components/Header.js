...
function Header() {
  ...
  return (
    <header className="container mx-auto md:flex justify-between py-4 md:py-6 max-width bg-white dark:bg-gray-900 shadow-md transition-all duration-300 ease-in-out">
      <div className="flex justify-between items-center">
        <div 
          onClick={toggleClass} 
          className="cursor-pointer md:hidden hover:bg-gray-100 dark:hover:bg-gray-800 p-2 rounded-md transition-colors duration-200"
        >
          <svg
      ...
      <nav 
        ...
        `}
      >
        <ul className="dark:text-light-content font-medium md:flex items-center md:space-x-8 mb-10 md:mb-0">
          {[
            { to: "/", label: "Home" },
            ...
            <li key={to} className="mb-6 md:mb-0">
              <NavLink 
                to={to} 
                onClick={toggleClass}
                className="
        ...
        <ul className="flex justify-center items-center space-x-6 mb-10 ml-6 md:mb-0">
          {[
            { href: instagram, icon: (
              <svg
                width="32"
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="dark:fill-light-heading fill-dark-heading hover:text-pink-500 dark:hover:text-pink-400 transition-colors duration-200"
              >
            ...
            { href: linkedin, icon: (
              <svg
                className="dark:fill-light-heading fill-dark-heading hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200"
                width="30"
                height="30"
                viewBox="0 0 30 30"
                fill="none"
            ...
            { href: github, icon: (
              <svg
                className="dark:fill-light-heading fill-dark-heading hover:text-gray-700 dark:hover:text-gray-300 transition-colors duration-200"
                width="30"
                height="30"
                viewBox="0 0 30 30"
                fill="none"
